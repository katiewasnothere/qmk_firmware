...
#define PRODUCT         katiewasnothere
#define DESCRIPTION     First Build

/* key matrix size */
#define MATRIX_ROWS 10
#define MATRIX_COLS 15

#define MATRIX_ROW_PINS { B0, E7, E6, F0, F1, F3, F4, F5, F6, F7}
#define MATRIX_COL_PINS {D3, D4, D5, B1, D7, E0, E1, C0, C1, C2, C3, C4, C5, C6, C7} // starting at C1/C2, the order may be wrong
#define UNUSED_PINS
